...
public static ProductoEN Convert (ProductoDTO dto)
{
        ...
        try
        {
                if (dto != null) {
                        ...
                        if (dto.LineaCompraProveedor_oid != null) {
                                ...
                                foreach (int entry in dto.LineaCompraProveedor_oid) {
                                        newinstance.LineaCompraProveedor.Add (lineaCompraProveedorCAD.ReadOIDDefault (entry));
                                }
                        }
